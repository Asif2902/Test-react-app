...
function App() {
  ...
  return (
    <div className="container">
      ...
      {/* Pass walletAddress to UnstakeSection */}
      <UnstakeSection contract={contract} updateTotalStaked={updateTotalStaked} updateWalletBalance={updateWalletBalance} walletAddress={walletAddress} />
